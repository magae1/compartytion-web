...
export default function Header({
  ...
  return (
    <div
      className={`${display} header-size z-10 w-full flex-none border-b border-slate-900/10 bg-base-100 backdrop-blur transition-colors duration-500 dark:border-slate-50/[0.06]`}
    >
      <div
